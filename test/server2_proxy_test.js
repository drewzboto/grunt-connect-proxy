...
exports.server2_proxy_test = {
  ...
  proxy_options_test: function(test) {
    ...
    test.equal(proxies.length, 8, 'should return eight valid proxies');
    ...
    test.equal(proxies[7].config.context, '/', 'should have context set from config');
    test.equal(proxies[7].config.host, 'www.server2.com', 'should have host set from config');
